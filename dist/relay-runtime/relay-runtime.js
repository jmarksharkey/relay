...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayResponseNormalizer = function () {
	  ...
	  RelayResponseNormalizer.prototype._validateRecordType = function _validateRecordType(record, field, payload) {
	    ...
	    __webpack_require__(10)(__webpack_require__(2).getType(record) === typeName, 'RelayResponseNormalizer: Invalid record `%s`. Expected %s to be ' + 'be consistent, but the record was assigned conflicting types ' + '`%s` and `%s`.', __webpack_require__(2).getDataID(record), TYPENAME_KEY, __webpack_require__(2).getType(record), typeName);
	  };
